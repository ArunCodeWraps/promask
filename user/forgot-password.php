                                            ...
                                            <div class="card-body">
                                                <form action="" method="post">
                                                    <div class="form-label-group">
                                                        <input type="email" name="forgotEmail" id="inputEmail" class="form-control" placeholder="Email" required>
                                                        <label for="inputEmail">Email</label>
                                                    </div>
                                                
                                                <div class="float-md-left d-block mb-1">
                                                    <a href="index.php" class="btn btn-outline-primary btn-block px-75 waves-effect waves-light">Back to Login</a>
                                                </div>
