                ...
                <div class="col-12">
                    <div class="form-group">
                      <div class="controls">	
                        ...
                        <input type="password" id="first-name-vertical" class="form-control" name="old_password" placeholder="Old Password" required data-validation-required-message="This Password field is required" value="<?php echo $_POST['old_password']; ?>">	
                      </div>  	                                           
                    </div>
                </div>
