    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" navigation-header"><span>Catalog</span>
                </li>
                <li class="<?php echo ($pageName =='category-list' || $pageName =='category-addf')?'active':'' ?> nav-item"><a href="category-list.php"><i class="feather icon-grid"></i><span class="menu-title" data-i18n="Email">Categories</span></a>
                </li>
                <li class="<?php echo ($pageName=='sub-category-list' || $pageName=='sub-category-addf')?'active':'' ?> nav-item"><a href="sub-category-list.php"><i class="feather icon-grid"></i><span class="menu-title" data-i18n="Email">Sub Categories</span></a>
                </li>
                <li class="<?php echo ($pageName=='product-list' || $pageName=='product-addf')?'active':'' ?> nav-item"><a href="product-list.php"><i class="fa fa-shopping-cart"></i><span class="menu-title" data-i18n="Email">Products</span></a>
                </li>
                ...
                <li class="<?php echo ($pageName=='banner-list' || $pageName=='banner-addf')?'active':'' ?> nav-item"><a href="banner-list.php"><i class="fa fa-file-image-o"></i><span class="menu-title" data-i18n="Email">Manage Banner</span></a>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-settings"></i><span class="menu-title" data-i18n="Ecommerce">Admin Setting</span></a>
                 ...
                 <li class=" navigation-header"><span>Coupon</span>
                </li>
                <li class="<?php echo ($pageName =='coupon-list' || $pageName =='coupon-addf')?'active':'' ?> nav-item"><a href="coupon-list.php"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Email">Manage Coupon</span></a>
                </li>

                <li class=" navigation-header"><span>Order</span>
                </li>
                <li class="<?php echo ($pageName =='order-list')?'active':'' ?> nav-item"><a href="order-list.php"><i class="feather icon-grid"></i><span class="menu-title" data-i18n="Email">Manage Order</span></a>
                </li>
                <li class="nav-item <?php echo ($pageName =='subscriber-list' || $pageName =='newsletter_template-list' || $pageName =='newsletter_template-addf' || $pageName =='send_newsletter')?'active open':'' ?>"><a href="#"><i class="feather icon-mail"></i><span class="menu-title" data-i18n="Manage Newsletter">Manage Newsletter</span></a>
                    <ul class="menu-content">
                        <li class="<?php echo ($pageName =='subscriber-list')?'submenu-active':'' ?>"><a href="subscriber-list.php"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Subscriber List">Subscriber List</span></a>
                        </li>
                        <li class="<?php echo ($pageName =='newsletter_template-list' || $pageName =='newsletter_template-addf')?'submenu-active':'' ?>"><a href="newsletter_template-list.php"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Newsletter Templates">Newsletter Templates</span></a>
                        </li>

                        <li class="<?php echo ($pageName =='send_newsletter')?'submenu-active':'' ?>"><a href="send_newsletter.php"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Newsletter Templates">Send Newsletter</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="<?php echo ($pageName =='seller-list' || $pageName =='seller-addf')?'active':'' ?> nav-item"><a href="seller-list.php"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Email">Manage Seller</span></a>
                </li>
                <li class="<?php echo ($pageName =='user-list' || $pageName =='user-addf')?'active':'' ?> nav-item"><a href="user-list.php"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Email">Manage User</span></a>
                </li>
