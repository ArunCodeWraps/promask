      ...
      <div class="row">
		...
		<form name="frm" method="post" action="city-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
              <table id="vender-grid" class="table table-bordered table-striped">
				...
				<?php
				$i=1;
				$sql=$obj->query("select * from $tbl_vender where 1=1 order by city asc",$debug=-1);
          ...
          <td><?php echo ucfirst(stripslashes($line->id)); ?></td>
					...
					<td><?php echo ucfirst(stripslashes($line->contact1)); ?><br/>
            <?php echo ucfirst(stripslashes($line->contact2)); ?><br/>
            <?php echo ucfirst(stripslashes($line->contact3)); ?>
          </td>
					<td align="center">
					<label class="switch">
		              <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?>  data-one="<?php echo $tbl_vender?>">
