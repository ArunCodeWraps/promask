...
<div class="wrapper">
 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-3 listpage"><h4>Manage User Group</h4></div>
        ...
        <div class="col-md-3"><p style="text-align:right">
          <span><input type="button" name="add" value="Add User Group"  class="button" onclick="location.href='usergroup-addf.php'" /></span>  
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <!-- /.box -->
    <form name="frm" method="post" action="usergroup-del.php" enctype="multipart/form-data">
          <div class="box">
            <div class="box-body">
        ...
        <?php
        $i=1;
        $sql=$obj->query("select * from $tbl_usergroup where 1=1 order by groupname asc",$debug=-1);
        while($line=$obj->fetchNextObject($sql)){?>
          ...
          <td><?php echo ucfirst(stripslashes($line->groupname)); ?></td>
          <td align="center">

                <label class="switch">
                  <input type="checkbox" class="chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_usergroup?>">
                  <div class="slider round"></div>
                </label>

          </td>
          <td><a href="usergroup-addf.php?id=<?php echo $line->id;?>" class="btn btn-primary" title="edit"> <i class="fa fa-pencil"></i></a>
          </td>
  ...
  function del_prompt(frmobj,comb)
    ...
    //alert(comb);
      if(comb=='Delete'){
        ...
        {
          frmobj.action = "usergroup-del.php";
