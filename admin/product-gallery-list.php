           ...
           <div class="content-header row">
                <div class="content-header-left col-md-12 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-8">
                            <h2 class="content-header-title float-left mb-0">Manage Gallery : <span><?php echo getField('name','tbl_product',$pid) ?></span></h2>
                        </div>
                        <div class="col-4" style="text-align: right;">
                            <button class="btn btn-outline-primary" onclick="document.location.href='product-list.php';"><span><i class="feather icon-corner-up-left"></i> Back</span></button>
                            <button class="btn btn-outline-primary" onclick="document.location.href='product-gallery-addf.php?pid=<?php echo $pid ?>';"><span><i class="feather icon-plus"></i> Add New</span></button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view">
                            ...
                            <tbody>
                              <?php
                              $i=1;
                              $sql=$obj->query("select * from $tbl_product_photo where 1=1 and product_id='$pid' order by id desc",$debug=-1);
                                ...
                                <tr>
                                    ...
                                    <td class="product-price">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                                            <input type="checkbox" class="custom-control-input chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_product_photo?>"  id="customSwitch<?php echo $line->id ?>">
                                            <label class="custom-control-label" for="customSwitch<?php echo $line->id ?>"></label>
                                        </div>
                                    </td>
                                    <td class="product-action">
                                        <a href="product-gallery-addf.php?id=<?php echo $line->id;?>&pid=<?php echo $pid ?>" title="Edit"><i class="feather icon-edit"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; }?>
    ...
    function del_prompt(frmobj,comb)
        ...
        //alert(comb);
            if(comb=='Delete'){
                ...
                {
                    frmobj.action = "product-gallery-del.php";
