<?php
  ...
  validate_admin();
  $obj->query("update tbl_promotional_order set new_order='1' ",$debug=-1);
?>
<!DOCTYPE html>
<html>
 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
        <div class="col-md-4"><h4>Notificación de promoción Lista de pedidos de productos</h4></div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <th width='60px'>
                  ...
                  <th style="text-align:center; width:100px">Solicitar ID</th>
                  <th style="text-align:center; width:150px">Nombre / ID de usuario</th>
                  <th style="text-align:center; width:150px">nombre del producto</th>
                  <th style="text-align:center; width:100px">Cantidad total</th>
                  <th style="text-align:center; width:100px">Método de pago</th>
                ...
                <tbody>
                 ...
                 $whr = 'order by id desc';
                  ...
                  $i=1;
                  $sql=$obj->query("select * from tbl_promotional_order where 1=1 $whr",$debug=-1);
                  while($line=$obj->fetchNextObject($sql)){?>
                   <tr>
                    ...
                    <td style="text-align:center"><?php echo date('d M Y H:i',strtotime($line->order_date)); ?><br/><?php echo CalculateOrderTime($line->order_date); ?></td>
                    <td style="text-align:center"><?php echo stripslashes($line->id); ?></td>
                    <td style="text-align:center"><?php echo getUserName($line->user_id)." <br/>(User Id :".stripslashes($line->user_id).") "; ?></td>
                    <td style="text-align:center"><?php echo getField('name','tbl_new_promotion',$line->product_id); ?></td>
                    <td style="text-align:center"><?php echo "$".number_format($line->total_amount,2); ?></td>
                    <td style="text-align:center"><?php echo ucfirst($line->payment_method);    ?></td>
                  ...
                  <td style="text-align:center">
                    <a href="view-promotion-notification-order-detail.php?order_id=<?php echo $line->id; ?>"  class="iframeOrder<?php echo $line->id; ?>" >
	...
	function del_prompt(frmobj,comb)
		...
		//alert(comb);
			if(comb=='Borrar'){
				...
				{
					frmobj.action = "promotion-order-notification-del.php";
