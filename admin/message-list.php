    ...
    <td align="right" class="paddRtLt70" valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="right" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="left" valign="middle" class="headingbg bodr text14"><em><img src="images/arrow2.gif" width="21" height="21" hspace="10" align="absmiddle" /></em>Admin: View Message</td>
              </tr>
              <form name="frm" method="post" action="message-del.php" enctype="multipart/form-data">
                <tr>
                  <td height="100" align="left" valign="top" bgcolor="#FFFFFF" class="bodr"><table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
						...
						$sql=$obj->Query("select * from $tbl_message where 1=1 order by $order_by $order_by2 limit $start, $pagesize");
						$sql2=$obj->query("select * from $tbl_message where 1=1 order by $order_by $order_by2",$debug=-1);
						...
						?>
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr bgcolor="<?php echo $bgcolor;?>">
                              ...
                              <td class="padd5"><?php echo date('d M Y H:i',$line->send_date); ?></td>
                              <td class="padd5"><?php echo ucfirst(getFieldWhere('name','tbl_user','id',$line->user_id)); ?></td>
                              <td class="padd5"><?php echo ucfirst(getFieldWhere('email','tbl_user','id',$line->user_id)); ?></td>
                              <td class="padd5"><?php echo ucfirst(getFieldWhere('phone','tbl_user','id',$line->user_id)); ?></td>
                              <td class="padd5"><?php echo stripslashes($line->enq_message); ?></td>
