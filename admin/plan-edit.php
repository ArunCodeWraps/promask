...
if($_REQUEST['submitForm']=='yes'){
	  ...
	  if($_REQUEST['id']==''){
		 ...
		 //   }
				...
				$obj->query("delete from $tbl_plan_features where plan_id='".$_REQUEST['id']."' ",$debug=-1); 

				foreach ($features as $value) {
			   	
			   		$obj->query("insert into $tbl_plan_features set plan_id='".$_REQUEST['id']."', name='$value' ",$debug=-1); 
			   }			     
				                       ...
				                       <form name="frm" method="POST" enctype="multipart/form-data" action="" class="form-horizontal" novalidate>
				                            ...
				                            <div class="form-body">
				                                <div class="row">
				                                    ...
				                                    <?php $count=$obj->numRows($PrSql);
											           if($count>0) { ?>
				                                    
											           	<?php while($line=$obj->fetchNextObject($PrSql)) { ?>
				                                   <!--  <div class="rows">	 -->
				                                   			<div class="row">
				                                   				<div class="col-11">
				                                   					<div class="form-group">
				                                   						<div class="controls">
				                                   							...
				                                   							<input type="text" class="form-control" name="featuresList[]" value="<?php echo $line->name ?>">
				                                   						</div>
				                                   					</div>
				                                    ...
				                                    <div class="col-12">
				                                        ...
				                                        <a class="add_field_button btn btn-primary mr-1 mb-1 waves-effect waves-light"><i class="fa fa-plus" aria-hidden="true"></i> Add More Feature</a>
				                                    </div>
				                                </div>
				                            </div>
				                        </form>
...
$(document).ready(function(){
    ...
    var wrappers = $('.input_fields_wraps'); //Input field wrapper
