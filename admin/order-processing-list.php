 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
        <div class="col-md-3"><h4>Manage Processing Orders</h4></div>
    ...
    <section class="content-header">
      <form name="searchactiveorderfrm" id="searchactiveorderfrm" method="post" accept="order-active-list.php"> 
        ...
        <div class="row">
          ...
          <div class="col-md-2"><label>&nbsp;</label>
            <a href="order-processing-list.php" class="form-control" style="background: #337ab7 none repeat scroll 0 0; border-radius: 3px; color: #fff; text-align: center;">Search All</a>
          </div>
          <div class="col-md-1"><label>&nbsp;</label></div>
        </div>
      </form>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                 ...
                 $whr = '';
                  ...
                  $i=1;
                  $sql=$obj->query("select * from $tbl_order where 1=1 and order_status=2 $whr",$debug=-1);
                    ...
                    <script>
                        ...
                        <td>
                          <a href="vieworder-detail.php?order_id=<?php echo $line->id; ?>"  class="iframeOrder<?php echo $line->id; ?>" >
                            ...
                            <a href="addprocessingcommets.php?order_id=<?php echo $line->id; ?>"  class="iframeAddc<?php echo $line->id; ?>"><img src="images/add.png" border="0" title="Add Comment" width="20" height="20"  /></a> &nbsp; 
