            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <th width='60px'>
                  ...
                  <th style="text-align:center; width:100px">SNo.</th>
                  ...
                  <th style="text-align:center; width:150px">Plan</th>
                ...
                <tbody>
                 ...
                 $whr = 'order by id desc';
                  ...
                  $i=1;
                  $sql=$obj->query("select * from $tbl_order where 1=1 $whr",$debug=-1);
                  while($line=$obj->fetchNextObject($sql)){?>
                   <tr>
                    ...
                    <td style="text-align:center"><?php echo stripslashes($line->ship_name)." ".stripslashes($line->ship_lname)." <br/>(User Id :".stripslashes($line->user_id).") "; ?></td>
                    <td style="text-align:center"><?php echo getField('name','tbl_plan',$line->plan_id); ?></td>
                    <td style="text-align:center"><?php echo "$".number_format($line->total_amount,2); ?></td>
                    <td style="text-align:center"><?php if($line->payment_method==1){ echo "Online"; }else if($line->payment_method==2){ echo "COD"; }else if ($line->payment_method==3){ echo "Member Key"; }  ?></td>
