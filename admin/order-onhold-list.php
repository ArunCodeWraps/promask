 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
        <div class="col-md-3"><h4>Manage On Hold Orders</h4></div>
    ...
    <section class="content-header">
      <form name="searchactiveorderfrm" id="searchactiveorderfrm" method="post" accept="order-active-list.php"> 
        ...
        <div class="row">
          ...
          <div class="col-md-2"><label>&nbsp;</label>
            <a href="order-onhold-list.php" class="form-control" style="background: #337ab7 none repeat scroll 0 0; border-radius: 3px; color: #fff; text-align: center;">Search All</a>
          </div>
          <div class="col-md-1"><label>&nbsp;</label></div>
        </div>
      </form>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                 ...
                 $whr = '';
                  ...
                  $i=1;
                  $sql=$obj->query("select * from $tbl_order where 1=1 and order_status=3 $whr",$debug=-1);
