                  ...
                  <div class="card">
                   <div class="card-header">
                        ...
                        <div class="col-6" style="text-align: right;">
                            <button class="btn btn-outline-primary" onclick="document.location.href='newsletter_template-addf.php';"><span><i class="feather icon-plus"></i> Add New Template</span></button>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table data-list-view1">
                            ...
                            <tbody>
                              <?php
                              $i=1;
                              $sql=$obj->query("select * from $tbl_newsletter_template where 1=1  order by id desc",$debug=-1);
                                ...
                                <tr>
                                    ...
                                    <td class="product-price">
                                        ...
                                        <div class="custom-control custom-switch custom-switch-success mr-2 mb-1">
                                            <input type="checkbox" class="custom-control-input chkstatus" value="<?php echo $line->id;?>" <?php echo ($line->status=="1")?'checked':'' ?> data-one="<?php echo $tbl_newsletter_template?>"  id="customSwitch<?php echo $line->id ?>">
                                            <label class="custom-control-label" for="customSwitch<?php echo $line->id ?>"></label>
                                        </div>
                                    </td>
                                     <td class="product-action">
                                        <a href="newsletter_template-addf.php?id=<?php echo $line->id;?>"><i class="feather icon-edit"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; }?>
