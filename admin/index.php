                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2">
                                                ...
                                                <form name="loginform" method="post" action="login.php">
                                                  <input type="hidden" name="logged" value="yes" />
                                                    ...
                                                    <div class="form-group d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div class="text-right"><a href="forgot-password.php" class="card-link">Forgot Password?</a></div>
                                                    </div>
                                        ...
                                        <div class="login-footer">
                                            <div class="divider">
                                                <?php if (!empty($_SESSION['sess_msg'])) {
                                                  echo "<p style='text-align:center;color:red'>".$_SESSION['sess_msg']."</p>"; $_SESSION['sess_msg']='';
                                                } ?>
                                            </div>
                                        </div>
                                    </div>
