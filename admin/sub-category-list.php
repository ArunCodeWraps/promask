           ...
           <div class="content-header row">
                <div class="content-header-left col-md-12 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-6">
                            <h2 class="content-header-title float-left mb-0">Sub Category List</h2>
                        </div>
                        <div class="col-6" style="text-align: right;">
                            <button class="btn btn-outline-primary" onclick="document.location.href='sub-category-addf.php';"><span><i class="feather icon-plus"></i> Add New</span></button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                              ...
                              while($line=$obj->fetchNextObject($sql)){?>
                                <tr>
                                    ...
                                    <td class="product-name"><?php echo getParentname($line->parent_id); ?></td>
                                    ...
                                    <td class="product-action">
                                        <a href="sub-category-addf.php?id=<?php echo $line->id;?>"><i class="feather icon-edit"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; }?>
    ...
    function del_prompt(frmobj,comb)
        ...
        //alert(comb);
            if(comb=='Delete'){
                ...
                {
                    frmobj.action = "sub-category-del.php";
