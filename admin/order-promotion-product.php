<?php
  ...
  validate_admin();
  $obj->query("update tbl_product_order set new_order='1' ",$debug=-1);
?>
<!DOCTYPE html>
<html>
 ...
 <?php include("menu.php"); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
            <div class="row">
        <div class="col-md-3"><h4>Lista de orden de productos de promoción</h4></div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <th width='60px'>
                  ...
                  <th style="text-align:center; width:400px">Fecha / hora del pedido</th>
                  <th style="text-align:center; width:100px">Solicitar ID</th>
                  <th style="text-align:center; width:100px">Nombre / ID de usuario</th>
                  <th style="text-align:center; width:150px">nombre del producto</th>
                  <th style="text-align:center; width:150px">Cantidad total</th>
                  <th style="text-align:center; width:100px">Metodo de pago</th>
                ...
                <tbody>
                 ...
                 $whr = 'order by id desc';
                  ...
                  $i=1;
                  $sql=$obj->query("select * from tbl_product_order where 1=1 $whr",$debug=-1);
                  ...
                  <td style="text-align:center">
                    <a href="view-promotion-order-detail.php?order_id=<?php echo $line->id; ?>"  class="iframeOrder<?php echo $line->id; ?>" >
	...
	function del_prompt(frmobj,comb)
		...
		//alert(comb);
			if(comb=='Borrar'){
				...
				{
					frmobj.action = "promotion-order-del.php";
